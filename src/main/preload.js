...
contextBridge.exposeInMainWorld("f95App", {
  ...
  updateGameSeasons: (payload) => ipcRenderer.invoke("games:updateSeasons", payload),
  ...
  updateGameFolderMetadata: (payload) => ipcRenderer.invoke("games:updateFolderMetadata", payload),
